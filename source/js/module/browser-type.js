...
export default function getBrowserType () {
  ...
  let timeZone = new Date().toString().match(/([A-Z]+[+-][0-9]+.*)/)[1]; // https://www.itranslater.com/qa/details/2103010833071604736
  let language = navigator.language; // https://oldj.net/blog/2019/06/15/get-the-language-of-browser/
  ...
  return {
    ...
    system: system, // windows osx linux android ios
    systemVs: systemVs,
    timeZone: timeZone,
    language: language,
    shell: shell,
